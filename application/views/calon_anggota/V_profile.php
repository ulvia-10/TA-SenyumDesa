...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		<div class="card-header py-10">
			<h6 class="m-0 font-weight-bold text-primary" style="font-size: 20px;">My Profile </h6>
            <div class="card-body">
				...
				<div class="row g-0">
					...
					<div class="col-md-8">
						<div class="card-body" >
                            ...
                            <p class="card-text"> Tanggal Lahir: <?= date('d-m-Y',strtotime($profile['tanggal_lahir'])); ?></p>
                            ...
                            <p class="card-text"><small class="text-muted">Mendaftar pada:  <?= date('d-m-Y H:i:s',strtotime($profile['created_at'])); ?></small></p>
						</div>
					</div>
				</div>
			</div>
