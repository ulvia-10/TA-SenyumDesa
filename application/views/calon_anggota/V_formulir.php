			...
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2">
					<div class="demo-form-wrapper">
						<form id="demo-form-wizard-1" action="<?php echo site_url('rekruitment/prosestambah')?>" method="POST"
							...
							<div class="tab-content">
								<div id="tab-1" class="tab-pane active">
									...
									<form action="<?php echo base_url('rekruitment/prosesTambah') ?>" method="POST" enctype="multipart/form-data">
									<div class="row">
										<div class="col-sm-8 col-sm-offset-2">
											...
											<div class="form-group">
												<label for="reason_join" class="control-label">Alasan Bergabung</label>
													...
													<div class="input-group">
														...
														<span class="input-group-btn">
															<label class="btn btn-primary file-upload-btn">
																<input id="form-control-22" class="file-upload-input"
												...
												<div class="col-sm-9">
													<div class="m-checkbox-inline custom-radio-ml">
														<div class="form-check form-check-inline radio radio-primary">
															<input class="form-check-input" id="radioinline4"
																type="radio" name="bukti_follow" id="bukti_follow"
																value="sudah" required="Gender harap DiIsi">
															<label class="form-check-label mb-0"
																for="radioinline4"><span class="digits">
																	Sudah</span></label>
														</div>
														<div class="form-check form-check-inline radio radio-primary">
															<input class="form-check-input" id="radioinline5"
																type="radio" name="bukti_follow" id="bukti_follow"
																value="belum">
															<label class="form-check-label mb-0"
																for="radioinline5"><span class="digits">
																	Belum</span></label>
														</div>
													</div>
												</div>
											...
											<div class="pricing-card">
												...
												<div class="pricing-card-body">
													...
													<label class="custom-control custom-control-primary custom-radio">
														...
														<span class="custom-control-label">Link: </span>
													</label>
												</div>
											</div>
										</div>
