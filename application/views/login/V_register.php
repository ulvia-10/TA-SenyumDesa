        ...
        <div class="register-form text-center">
          <form id="contact-form" method="post" action="">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <input id="form_name" type="text" name="full_name" class="form-control" placeholder="Full Name" required="required" data-error="Full Name is required.">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="help-block with-errors"></div>
						...
						<div class="col-md-6">
						<div class="form-group">
							<input class="form-control digits" class="form-control" type="date" value=" Tanggal Lahir" name="tanggal_lahir"
								id="tanggal_lahir">
						</div>
            </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <input id="form_asal" type="text" name="asal" class="form-control" placeholder="Asal Kampus/Instansi/Kerja" required="required" data-error=" Asal is required">
                  <div class="help-block with-errors"></div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col">
                ...
                <span class="mt-4 d-block">Have An Account ? <a href="<?php echo base_url('login/register') ?>"><i>Sign In!</i></a></span>
              </div>
            </div>
          </form>
        </div>
