                    ...
                    <ul class="nav-menus">
                        ...
                        <li class="onhover-dropdown">
                            ...
                            <ul class="notification-dropdown onhover-show-div">
                                ...
                                <li>
                                    <p>
                                        <i class="fa fa-circle-o me-3 font-primary">
                                            <?= $bell['tanggal_notifikasi'] ?><br>
                                        </i>
                                        <i class="fa fa-circle-o me-3 font-primary">
                                            <?= $bell['tema'] ?>
                                        </i>
                        ...
                        <div id="sidebar-menu">
                            <ul class="sidebar-links" id="simple-bar">
                                ...
                                <li class="sidebar-list"
                                    <?= $this->uri->segment(2) == 'Dashboard' ? 'class="sidebar-submenu"' : '' ?>>
                                ...
                                <li class="sidebar-list"
                                    <?= $this->uri->segment(2) == 'tabelKegiatan' ? 'class="sidebar-submenu"' : '' ?>>
                                    <a class="sidebar-link sidebar-title link-nav"
