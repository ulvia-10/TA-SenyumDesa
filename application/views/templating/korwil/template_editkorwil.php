...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Roboto:300,300i,400,400i,500,500i,700,700i,900&amp;display=swap"
        rel="stylesheet">
    <!-- latest jquery-->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/pusatbackend/css/vendors/select2.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/pusatbackend/css/vendors/dropzone.css">
    ...
    <!-- Plugins css start-->
    <link rel="stylesheet" type="text/css"
        href="<?php echo base_url('assets/pusatbackend/css/vendors/scrollbar.css'); ?>">
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/pusatbackend/css/vendors/select2.css'); ?>">
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/pusatbackend/css/vendors/sweetalert2.css'); ?>">
    <link rel="stylesheet" type="text/css"
                    ...
                    <ul class="nav-menus">
                        ...
                        <li class="onhover-dropdown"><i data-feather="message-square"></i>
                            <ul class="chat-dropdown onhover-show-div">
                                ...
                                <li>
                                    <div class="media"><img class="img-fluid rounded-circle me-3" width="40px"
                                            height="40px"
                        ...
                        <li class="profile-nav onhover-dropdown p-0 me-0">
                            <div class="media profile-media"><img class="b-r-10" width="40px" heighy="40px"
                    ...
                    <nav class="sidebar-main">
                        ...
                        <div id="sidebar-menu">
                            <ul class="sidebar-links" id="simple-bar">
                                <li class="back-btn"><a href="<?= base_url('Adminkorwil/Dashboard'); ?>"><img
                                            class="img-fluid for-light"
                                ...
                                <li class="sidebar-list"
                                    <?= $this->uri->segment(1) == 'Adminkorwil/tabelKeuangan' || $this->uri->segment(1) == '' ? 'class="active"' : '' ?>>
                                    <a class="sidebar-link sidebar-title link-nav"
