...
<head>
    ...
    <link rel="icon" href="<?= base_url('assets/pusatbackend/images/logo.png'); ?>" type="image/x-icon">
    <link rel="shortcut icon" href="<?= base_url('assets/pusatbackend/images/logo.png'); ?>" type="image/x-icon">
    <title><?= $title ?></title>
    <!-- Google font-->
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/pusatbackend/css/vendors/datatables.css'); ?>">
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/pusatbackend/css/fontawesome.css'); ?>">
    <!-- ico-font-->
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/pusatbackend/css/vendors/icofont.css'); ?>">
    <!-- Themify icon-->
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/pusatbackend/css/vendors/themify.css'); ?>">
    <!-- Flag icon-->
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/pusatbackend/css/vendors/flag-icon.css'); ?>">
    <!-- Feather icon-->
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/pusatbackend/css/vendors/feather-icon.css'); ?>">
    <!-- Plugins css start-->
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/pusatbackend/css/vendors/scrollbar.css'); ?>">
    ...
    <!-- Plugins css Ends-->
    <!-- Bootstrap css-->
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/pusatbackend/css/vendors/bootstrap.css'); ?>">
    <!-- App css-->
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/pusatbackend/css/style.css'); ?>">
    <link id="color" rel="stylesheet" href="<?= base_url('assets/pusatbackend/css/color-1.css'); ?>" media="screen">
    <!-- Responsive css-->
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/pusatbackend/css/responsive.css'); ?>">
</head>
...
<body onload="startTime()">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12 footer-copyright text-center">
                            <p class="mb-0">Copyright 2021 © pusat Senyum desa </p>
                        </div>
                    </div>
                </div>
            </footer>
    ...
    <script src="http://admin.pixelstrap.com/cuba/assets/js/datatable/datatables/jquery.dataTables.min.js"></script>
    <script src="http://admin.pixelstrap.com/cuba/assets/js/datatable/datatables/datatable.custom.js"></script>
    <!-- latest jquery-->
    <script src="<?= base_url('assets/pusatbackend/js/datatable/datatables/jquery.dataTables.min.js'); ?>"></script>
    <script src="<?= base_url('assets/pusatbackend/js/datatable/datatables/datatable.custom.js'); ?>"></script>
    <script src="<?= base_url('assets/pusatbackend/js/jquery-3.5.1.min.js'); ?>"></script>
    <!-- Bootstrap js-->
    <script src="<?= base_url('assets/pusatbackend/js/bootstrap/bootstrap.bundle.min.js'); ?>"></script>
    <!-- feather icon js-->
    <script src="<?= base_url('assets/pusatbackend/js/icons/feather-icon/feather.min.js'); ?>"></script>
    <script src="<?= base_url('assets/pusatbackend/js/icons/feather-icon/feather-icon.js'); ?>"></script>
    <!-- scrollbar js-->
    <script src="<?= base_url('assets/pusatbackend/js/scrollbar/simplebar.js'); ?>"></script>
    <script src="<?= base_url('assets/pusatbackend/js/scrollbar/custom.js'); ?>"></script>
    <!-- Sidebar jquery-->
    <script src="<?= base_url('assets/pusatbackend/js/config.js'); ?>"></script>
    <!-- Plugins JS start-->
    <script src="<?= base_url('assets/pusatbackend/js/sidebar-menu.js'); ?>"></script>
    ...
    <!-- Plugins JS Ends-->
    <!-- Theme js-->
    <script src="<?= base_url('assets/pusatbackend/js/script.js'); ?>"></script>
    <script src="<?= base_url('assets/pusatbackend/js/theme-customizer/customizer.js'); ?>"></script>
    <!-- login js-->
    <!-- Plugin used-->
</body>
