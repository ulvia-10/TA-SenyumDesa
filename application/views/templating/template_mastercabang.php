...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Roboto:300,300i,400,400i,500,500i,700,700i,900&amp;display=swap"
        rel="stylesheet">
    <link href="<?= base_url('assets/backend/fontawesome-free/css/all.min.css'); ?>" rel="stylesheet" type="text/css">
    <!-- ico-font-->
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/backend/css/vendors/bootstrap.css'); ?>">
...
<body>
                    ...
                    <ul class="nav-menus">
                            ...
                            <ul class="cart-dropdown onhover-show-div">
                                ...
                                <li class="mt-0">
                                    <div class="media"><img class="img-fluid rounded-circle me-3 img-60"
                                            src="<?php echo base_url() ?>assets/backend/images/ecommerce/01.jpg" alt="">
                                        ...
                                        <div class="close-circle"><a href="dashboard-02.html#"><i
                                                    data-feather="x"></i></a></div>
                                    </div>
                                </li>
                                <li class="mt-0">
                                    <div class="media"><img class="img-fluid rounded-circle me-3 img-60"
                                            src="<?php echo base_url() ?>assets/backend/images/ecommerce/03.jpg" alt="">
                                        <div class="media-body"><span>V-Neck Shawl Collar Woman's Solid T-Shirt</span>
                                            <p>Yellow(#fcb102)</p>
                                            <div class="qty-box">
                                                <div class="input-group"><span class="input-group-prepend">
                        ...
                        <li class="profile-nav onhover-dropdown p-0 me-0">
                            ...
                            <ul class="profile-dropdown onhover-show-div">
                                ...
                                <li><a href="<?php echo base_url('login/logout') ?>"><i data-feather="log-in">
                                        </i><span>Log in</span></a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
    ...
    <script src="<?= base_url('assets/backend/js/scrollbar/simplebar.js'); ?>"></script>
    <script src="<?= base_url('assets/backend/js/scrollbar/custom.js'); ?>"></script>
