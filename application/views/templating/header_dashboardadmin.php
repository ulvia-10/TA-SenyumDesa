...
<head>
    ...
    <link rel="icon" href="<?= base_url('assets/pusatbackend/images/favicon.png'); ?>" type="image/x-icon">
    <link rel="shortcut icon" href="<?= base_url('assets/pusatbackend/images/favicon.png'); ?>" type="image/x-icon">
    <title><?= $title ?></title>
    <!-- Google font-->
