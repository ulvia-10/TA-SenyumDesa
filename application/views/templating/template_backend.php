    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
        ...
        <div class="header-wrapper row m-0">
          ...
          <div class="left-header col horizontal-wrapper ps-0">
            <ul class="horizontal-menu">
              <li class="mega-menu outside"><a class="nav-link" href="dashboard-02.html#!"><i data-feather="layers"></i><span>Bonus Ui</span></a>
                
              </li>
              <li class="level-menu outside"><a class="nav-link" href="dashboard-02.html#!"><i data-feather="inbox"></i><span>Level Menu</span></a>
                <ul class="header-level-menu menu-to-be-close">
                  ...
                  <li><a href="dashboard-02.html#!" data-original-title="" title="">                               <i data-feather="users"></i><span>Users</span></a>
            ...
            <ul class="nav-menus">
              ...
              <li class="cart-nav onhover-dropdown">
                ...
                <ul class="cart-dropdown onhover-show-div">
                  ...
                  <li class="mt-0">
                    <div class="media"><img class="img-fluid rounded-circle me-3 img-60" src="<?php echo base_url() ?>assets/backend/images/ecommerce/01.jpg" alt="">
                      ...
                      <div class="close-circle"><a href="dashboard-02.html#"><i data-feather="x"></i></a></div>
                    </div>
                  </li>
                  <li class="mt-0">
                    <div class="media"><img class="img-fluid rounded-circle me-3 img-60" src="<?php echo base_url() ?>assets/backend/images/ecommerce/03.jpg" alt="">
                      <div class="media-body"><span>V-Neck Shawl Collar Woman's Solid T-Shirt</span>
                        <p>Yellow(#fcb102)</p>
                        <div class="qty-box">
                          <div class="input-group"><span class="input-group-prepend">
              ...
              <li class="maximize"><a class="text-dark" href="dashboard-02.html#!" onclick="javascript:toggleFullScreen()"><i data-feather="maximize"></i></a></li>
              <li class="profile-nav onhover-dropdown p-0 me-0">
                <div class="media profile-media"><img class="b-r-10" src="<?php echo base_url() ?>assets/backend/images/dashboard/profile.jpg" alt="">
                  <div class="media-body"><span><?php echo $this->session->userdata('sess_fullname') ?></span>
                    <p class="mb-0 font-roboto"><?php echo ucfirst($this->session->userdata('sess_level')) ?> <i class="middle fa fa-angle-down"></i></p>
                  </div>
                </div>
                <ul class="profile-dropdown onhover-show-div">
                  ...
                  <li><a href="<?php echo base_url('login/logout') ?>"><i data-feather="log-in"> </i><span>Log in</span></a></li>
                </ul>
              </li>
            </ul>
          </div>
      ...
      <div class="page-body-wrapper">
        ...
        <div class="sidebar-wrapper">
          <div>
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="<?php echo base_url() ?>assets/backend/images/logo/logo.png" alt=""><img class="img-fluid for-dark" src="<?php echo base_url() ?>assets/backend/images/logo/logo_dark.png" alt=""></a>
              <div class="back-btn"><i class="fa fa-angle-left"></i></div>
              <div class="toggle-sidebar"><i class="status_toggle middle sidebar-toggle" data-feather="grid"> </i></div>
            </div>
            <div class="logo-icon-wrapper"><a href="index.html"><img class="img-fluid" src="<?php echo base_url() ?>assets/backend/images/logo/logo-icon.png" alt=""></a></div>
            <nav class="sidebar-main">
              <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  <li class="back-btn"><a href="index.html"><img class="img-fluid" src="<?php echo base_url() ?>assets/backend/images/logo/logo-icon.png" alt=""></a>
                ...
                <?php $ambilController = $this->uri->segment(1); ?>
                  ...
                  <li class="sidebar-list">
                    ...
                    <a class="sidebar-link active <?php if ( $ambilController == "dashboard" ) echo "active"; ?>" href="<?php echo base_url('dashboard/index') ?>"><i data-feather="home"></i><span class="lan-3">Dashboard</span></a>
                  </li>
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="<?php echo base_url('master/index') ?>"><i data-feather="airplay"></i><span class="lan-6">Master Cabang</span></a>
                  </li>
                  
                  <li class="sidebar-list">
                    <a class="sidebar-link" href="<?php echo base_url('master/index') ?>"><i data-feather="activity"></i>Master Cabang</a>
                  </li>
