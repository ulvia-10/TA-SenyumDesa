                         ...
                         <div class="card-body">
                             ...
                             <div class="greeting-user text-center">
                                 <div class="profile-vector"><img class="img-fluid"
                                         src="<?php echo base_url() ?>assets/pusatbackend/images/dashboard/welcome.png"
                                         alt=""></div>
                                 ...
                                 <div class="card-body">
                                     <div class="body-bottom">
                                         <h6> 10% off For drama lights Couslations...</h6><span
                                             class="font-roboto">Lorem Ipsum is simply
                                             dummy...It is a long established fact that a reader will be distracted by
                                         </span>
                                     </div>
                                 </div>
                             </div>
                             ...
                             <div class="chat">
                                 <div class="media left-side-chat">
                                     <div class="media-body d-flex">
                                         <div class="img-profile"> <img class="img-fluid"
                                                 src="<?php echo base_url() ?>assets/pusatbackend/images/user.jpg"
                                                 alt="Profile">
                                         </div>
                                         <div class="main-chat">
                                 ...
                                 <div class="media right-side-chat">
                                     ...
                                     <div class="media-body text-end">
                                         <div class="message-main pull-right"><span class="mb-0 text-start">How can do
                                                 for you</span>
